...
var LOCALES = {
  en: {
    ...
    gamepad_join_hint: 'Press any button on your controller',
  ...
  de: {
    ...
    gamepad_join_hint: 'Beliebige Taste am Controller drücken',
  ...
  fr: {
    ...
    gamepad_join_hint: 'Appuie sur une touche de ta manette',
  ...
  pt: {
    ...
    gamepad_join_hint: 'Aperta qualquer botão do controle',
  ...
  es: {
    ...
    gamepad_join_hint: 'Pulsa cualquier botón del mando',
  ...
  ja: {
    ...
    gamepad_join_hint: 'コントローラーのボタンを押す',
  ...
  ko: {
    ...
    gamepad_join_hint: '컨트롤러의 아무 버튼이나 누르기',
  ...
  ru: {
    ...
    gamepad_join_hint: 'Нажми любую кнопку на геймпаде',
  ...
  it: {
    ...
    gamepad_join_hint: 'Premi un tasto sul controller',
  ...
  tr: {
    ...
    gamepad_join_hint: 'Kumandanda bir tuşa bas',
