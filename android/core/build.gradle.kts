...
tasks.withType<Test>().configureEach {
    ...
    // RoomBrain module produces in Node and in JavaScriptCore on tvOS.
    systemProperty("hexcore.roombrain.golden", repoRoot.file("tests/fixtures/room-brain-golden.json").asFile.absolutePath)
